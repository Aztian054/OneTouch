...
<div class="page-header">
  <div><div class="page-title">Data Inspeksi</div><div class="page-subtitle">Kelola inspeksi lingkup penugasan Anda</div></div>
  <div class="page-actions">
    <a href="{{ route('officer.inspeksi.create') }}" class="btn btn-primary btn-sm"><i class="fas fa-plus"></i> Tambah</a>
  </div>
</div>
...
<div class="card" style="margin-bottom:16px">
  <div class="card-body" style="padding:12px 16px">
    <form method="GET" style="display:flex; gap:10px; flex-wrap:wrap; align-items:flex-end">
      ...
      <a href="{{ route('officer.inspeksi.index') }}" class="btn btn-sm" style="background:var(--border); color:var(--text)"><i class="fas fa-times"></i></a>
    </form>
  </div>
</div>
        ...
        <tr>
          ...
          <td>
            <div style="display:flex; gap:4px">
              <a href="{{ route('officer.inspeksi.show',$i->id) }}" class="btn btn-icon btn-sm" title="Detail"><i class="fas fa-eye"></i></a>
              <a href="{{ route('officer.inspeksi.edit',$i->id) }}" class="btn btn-icon btn-sm" title="Edit"><i class="fas fa-pencil-alt"></i></a>
              <form method="POST" action="{{ route('officer.inspeksi.destroy',$i->id) }}" onsubmit="return confirm('Hapus inspeksi ini?')">
                @csrf @method('DELETE')
