...
<div class="page-header">
  <div><div class="page-title">Laporan</div><div class="page-subtitle">Unduh laporan data sertifikat dan inspeksi Anda</div></div>
</div>
...
function downloadReport(type, format) {
  ...
  const routes = {
    sertifikat: {
      pdf:   '{{ route("user.laporan.sertifikat.pdf") }}',
      excel: '{{ route("user.laporan.sertifikat.excel") }}'
    },
    inspeksi: {
      pdf:   '{{ route("user.laporan.inspeksi.pdf") }}',
      excel: '{{ route("user.laporan.inspeksi.excel") }}'
    }
  };
