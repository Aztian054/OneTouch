...
<div class="page-header">
  <div>
    ...
    <div class="page-subtitle">Selamat datang, {{ auth()->user()->name }}. Berikut ringkasan data sistem.</div>
  </div>
</div>
...
<div class="stats-grid">
  ...
  <div class="stat-card">
    ...
    <div><div class="stat-value">{{ $totalOfficer }}</div><div class="stat-label">Officer</div></div>
  </div>
  <div class="stat-card">
    <div class="stat-icon navy"><i class="fas fa-users"></i></div>
    <div><div class="stat-value">{{ $totalUser }}</div><div class="stat-label">User Aktif</div></div>
  </div>
</div>
...
<div style="display:grid; grid-template-columns:1fr 1.4fr; gap:20px; margin-bottom:20px">
  ...
  <div class="card">
    <div class="card-header">
      ...
      <a href="{{ route('admin.sertifikat.index') }}" class="btn btn-outline btn-sm">Lihat Semua</a>
    </div>
...
<div class="card">
  <div class="card-header">
    ...
    <a href="{{ route('admin.inspeksi.index') }}" class="btn btn-outline btn-sm">Lihat Semua</a>
  </div>
  <div class="table-wrap">
    <table class="data-table">
